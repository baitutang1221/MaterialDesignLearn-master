package com.example.administrator.materialdesignlearn_master.adapter;
...
public class FragmentRecyclerAdapter  extends  RecyclerView.Adapter<FragmentRecyclerAdapter.ViewHolder>{
    ...
    private String[] names={"非常好","还不错","好烂啊","天下良心啊","下次还来","必须顶","beautful","非常好","还不错","好烂啊","天下良心啊","下次还来","必须顶","beatiful"};
